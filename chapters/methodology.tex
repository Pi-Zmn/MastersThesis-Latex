...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item Implement support for multiple datatypes of task results (primitiv datatypes, lists, files as binary)
  \end{itemize}
...
\subsection{Database}
An object-relational database system fulfills WebArgos's requirements, as these systems typically offer high performance capabilities and the entities described in \autoref{sec:concept:terminology} can be represented with an object-relational database schema.
