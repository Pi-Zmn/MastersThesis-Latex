...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=0.5\textwidth]{gfx/figures/Entities.jpg}
...
\begin{figure}[bth]
  ...
  \subfloat[Asia personas duo.]{
     ...
     \includegraphics[width=.45\linewidth]{gfx/figures/Entities.jpg}
   } \quad
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[b]{5 cm}
    \includegraphics[width=\linewidth]{gfx/figures/Entities.jpg} 
